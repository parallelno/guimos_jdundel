...
lv_ram_disk_s_gfx:				.storage BYTE_LEN		; .byte RAM_DISK_S_LEVEL00_GFX
level_ram_disk_m_gfx:				.storage BYTE_LEN		; .byte RAM_DISK_M_LEVEL00_GFX
lv_palette_ptr:					.storage ADDR_LEN	; .word _level00_palette
lv_resources_inst_data_pptr:		.storage ADDR_LEN		; .word _level00_resources_inst_data_ptrs
lv_containers_inst_data_pptr:	.storage ADDR_LEN		; .word _level00_containers_inst_data_ptrs
lv_start_pos:				.storage ADDR_LEN		; .word _level00_start_pos
lv_rooms_pptr:					.storage ADDR_LEN		; .word _level00_rooms_addr
lv_tiles_pptr:					.storage ADDR_LEN		; .word _level00_tiles_pptr
level_init_tbl_end:
...
monster_data_prev_ptr:		.storage ADDR_LEN ; .word TEMP_WORD
monster_data_next_ptr:		.storage ADDR_LEN ; .word TEMP_WORD
@data_end:
