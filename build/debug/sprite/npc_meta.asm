...
_npc_friends_mom_idle0_0_relative = 2
_npc_friends_mom_idle1_0_relative = 136
_npc_friends_mom_idle2_0_relative = 270
...
_npc_dotty_idle2_0_relative = 1318
_npc_greenhat_idle0_0_relative = 1452
_npc_greenhat_idle1_0_relative = 1586
_npc_greenhat_idle2_0_relative = 1720
_npc_boy_idle0_0_relative = 1854
_npc_boy_idle1_0_relative = 1980
_npc_boy_idle2_0_relative = 2106
_npc_oldman_idle0_0_relative = 2232
_npc_oldman_idle1_0_relative = 2366
_npc_oldman_idle2_0_relative = 2500
_npc_mom_idle0_0_relative = 2634
_npc_mom_idle1_0_relative = 2768
_npc_mom_idle2_0_relative = 2902
_npc_scarecrow_idle0_0_relative = 3036
_npc_scarecrow_idle1_0_relative = 3170
_npc_scarecrow_idle2_0_relative = 3304
...
npc_preshifted_sprites:
			.byte 1
npc_anims:
			.word npc_friends_mom_idle_anim, npc_sis_idle_anim, npc_bob_idle_anim, npc_dotty_idle_anim, npc_greenhat_idle_anim, npc_boy_idle_anim, npc_oldman_idle_anim, npc_mom_idle_anim, npc_scarecrow_idle_anim, EOD
npc_friends_mom_idle_anim:
			.byte 3, 0 ; offset to the next frame
			.word _npc_friends_mom_idle0_0_relative, 
			.byte 3, 0 ; offset to the next frame
			.word _npc_friends_mom_idle0_0_relative, 
			.byte 3, 0 ; offset to the next frame
			.word _npc_friends_mom_idle1_0_relative, 
			.byte 3, 0 ; offset to the next frame
			.word _npc_friends_mom_idle2_0_relative, 
			.byte 3, 0 ; offset to the next frame
			.word _npc_friends_mom_idle2_0_relative, 
...
npc_dotty_idle_anim:
			...
			.byte 3, 0 ; offset to the next frame
			.word _npc_dotty_idle2_0_relative, 
			.byte 243, $ff ; offset to the first frame
			.word _npc_dotty_idle1_0_relative, 
npc_greenhat_idle_anim:
			...
			.byte 3, 0 ; offset to the next frame
			.word _npc_greenhat_idle2_0_relative, 
			.byte 243, $ff ; offset to the first frame
			.word _npc_greenhat_idle1_0_relative, 
npc_boy_idle_anim:
			.byte 3, 0 ; offset to the next frame
			...
			.byte 3, 0 ; offset to the next frame
			.word _npc_boy_idle2_0_relative, 
			.byte 243, $ff ; offset to the first frame
			.word _npc_boy_idle1_0_relative, 
npc_oldman_idle_anim:
			...
			.byte 3, 0 ; offset to the next frame
			.word _npc_oldman_idle2_0_relative, 
			.byte 243, $ff ; offset to the first frame
			.word _npc_oldman_idle1_0_relative, 
npc_mom_idle_anim:
			.byte 3, 0 ; offset to the next frame
