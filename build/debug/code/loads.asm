...
;===============================================
			...
			LEVEL0_GOOSE_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_GOOSE_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_GOOSE_ADDR = 0x61F6

			LEVEL0_TI0_GFX_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_TI0_GFX_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_TI0_GFX_ADDR = 0x7016

			LEVEL0_SNOWFLAK_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_SNOWFLAK_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_SNOWFLAK_ADDR = 0x7C70

			LEVEL0_TXT_LV0_RAM_DISK_M = RAM_DISK_M1
			LEVEL0_TXT_LV0_RAM_DISK_S = RAM_DISK_S1
			LEVEL0_TXT_LV0_ADDR = 0x8F3E

			LEVEL0_PAL_LV0_RAM_DISK_M = RAM_DISK_M1
			LEVEL0_PAL_LV0_RAM_DISK_S = RAM_DISK_S1
			LEVEL0_PAL_LV0_ADDR = 0x9F12
			...
			LEVEL0_KNIGHT_ADDR = 0x9724

			LEVEL0_NPC4_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_NPC4_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_NPC4_ADDR = 0xC0CC

			LEVEL0_SKELETON_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_SKELETON_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_SKELETON_ADDR = 0xDDF4

			LEVEL0_SCYTHE_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_SCYTHE_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_SCYTHE_ADDR = 0xF7F8

			LEVEL0_FIREPOOL_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_FIREPOOL_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_FIREPOOL_ADDR = 0xFC24

			LEVEL0_TI0_DATA_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_TI0_DATA_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_TI0_DATA_ADDR = 0xFE52
...
;===============================================
			...
			LEVEL1_KNIGHT_ADDR = 0x8344

			LEVEL1_SKELETON_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_SKELETON_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_SKELETON_ADDR = 0xACEC

			LEVEL1_LV1_GFX_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_LV1_GFX_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_LV1_GFX_ADDR = 0xC6F0

			LEVEL1_BURNER_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_BURNER_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_BURNER_ADDR = 0xE032

			LEVEL1_SNOWFLAK_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_SNOWFLAK_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_SNOWFLAK_ADDR = 0xF816

			LEVEL1_TNT_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_TNT_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_TNT_ADDR = 0xFB56

			LEVEL1_TI0_DATA_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_TI0_DATA_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_TI0_DATA_ADDR = 0xFE26
