...
Ram-disk usage:
	...
	TEXT_LV0.BIN [addr: 17258, len:5190], 
	FONT.BIN [addr: 22448, len:1624], 
...
.function load_permanent
			...
			SONG01_ADDR = STACK_MIN_ADDR - 0 - SONG01_FILE_LEN
...
.function load_level0
			...
			RAM_DISK_S_FONT = RAM_DISK_S2
			FONT_ADDR = 22448
			LOAD_FILE(FONT_FILENAME_PTR, RAM_DISK_S_FONT, FONT_ADDR, FONT_FILE_LEN)

.endf
LOADED_DATA_START_ADDR = STACK_MIN_ADDR - 8548
