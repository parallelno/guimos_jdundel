...
Ram-disk usage:
	...
	>>> WASTED_SPACE <<< [addr: 38572, len:2388]

	bank idx: 1
	HERO_R.BIN [addr: 0, len:13176], 
	KNIGHT.BIN [addr: 13176, len:15780], 
	SKELETON.BIN [addr: 28956, len:9870], 
	SCYTHE.BIN [addr: 38826, len:1554], 

	>>> WASTED_SPACE <<< [addr: 40380, len:580]

	bank idx: 2
	SNOWFLAK.BIN [addr: 0, len:1212], 
	TNT.BIN [addr: 1212, len:1056], 
	VFX4.BIN [addr: 2268, len:3888], 
	LV0_DATA.BIN [addr: 6156, len:3638], 
	BOMB.BIN [addr: 9794, len:960], 
