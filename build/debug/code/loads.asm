...
;===============================================
			...
			LEVEL0_SNOWFLAK_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_SNOWFLAK_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_SNOWFLAK_ADDR = 0xFC2C

			LEVEL0_PAL_LV0_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_PAL_LV0_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_PAL_LV0_ADDR = 0xFF6C
