...
;===============================================
			...
			LEVEL0_TI0_GFX_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_TI0_GFX_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_TI0_GFX_ADDR = 0x61F6

			LEVEL0_NPC_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_NPC_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_NPC_ADDR = 0x6E50

			LEVEL0_SCYTHE_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_SCYTHE_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_SCYTHE_ADDR = 0x781A

			LEVEL0_FIREPOOL_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_FIREPOOL_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_FIREPOOL_ADDR = 0x7C46

			LEVEL0_TI0_DATA_RAM_DISK_M = RAM_DISK_M1
			LEVEL0_TI0_DATA_RAM_DISK_S = RAM_DISK_S1
			LEVEL0_TI0_DATA_ADDR = 0x0000

			LEVEL0_TXT_LV0_RAM_DISK_M = RAM_DISK_M1
			LEVEL0_TXT_LV0_RAM_DISK_S = RAM_DISK_S1
			LEVEL0_TXT_LV0_ADDR = 0x8F3E

			LEVEL0_KNIGHT_RAM_DISK_M = RAM_DISK_M2
			LEVEL0_KNIGHT_RAM_DISK_S = RAM_DISK_S2
			LEVEL0_KNIGHT_ADDR = 0xB044

			LEVEL0_HERO_L_RAM_DISK_M = RAM_DISK_M2
			LEVEL0_HERO_L_RAM_DISK_S = RAM_DISK_S2
			LEVEL0_HERO_L_ADDR = 0xD9EC

			LEVEL0_SNOWFLAK_RAM_DISK_M = RAM_DISK_M2
			LEVEL0_SNOWFLAK_RAM_DISK_S = RAM_DISK_S2
			LEVEL0_SNOWFLAK_ADDR = 0xFCAC
...
;===============================================
			...
			LEVEL1_HERO_R_ADDR = 0x8346

			LEVEL1_SKELETON_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_SKELETON_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_SKELETON_ADDR = 0xA606

			LEVEL1_LV1_GFX_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_LV1_GFX_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_LV1_GFX_ADDR = 0xC00A

			LEVEL1_BURNER_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_BURNER_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_BURNER_ADDR = 0xD990

			LEVEL1_TI0_GFX_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_TI0_GFX_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_TI0_GFX_ADDR = 0xF174

			LEVEL1_FIREPOOL_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_FIREPOOL_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_FIREPOOL_ADDR = 0xFDCE
