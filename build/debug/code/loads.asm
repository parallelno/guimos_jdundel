...
.function load_level0
			; ram-disk:
			RAM_DISK_M_HERO_R = RAM_DISK_M0
			RAM_DISK_S_HERO_R = RAM_DISK_S0
			HERO_R_ADDR = 0
			...
			RAM_DISK_M_LV1_GFX = RAM_DISK_M0
			RAM_DISK_S_LV1_GFX = RAM_DISK_S0
			LV1_GFX_ADDR = 34392
			LOAD_FILE(LV1_GFX_FILENAME_PTR, RAM_DISK_S_LV1_GFX, LV1_GFX_ADDR, LV1_GFX_FILE_LEN)
			call lv1_gfx_init
			...
			RAM_DISK_M_HERO_L = RAM_DISK_M2
			RAM_DISK_S_HERO_L = RAM_DISK_S2
			HERO_L_ADDR = 45124
			...
			RAM_DISK_M_LV0_GFX = RAM_DISK_M2
			RAM_DISK_S_LV0_GFX = RAM_DISK_S2
			LV0_GFX_ADDR = 58300
			...
			RAM_DISK_M_LV1_DATA = RAM_DISK_M3
			RAM_DISK_S_LV1_DATA = RAM_DISK_S3
			LV1_DATA_ADDR = 32768
			LOAD_FILE(LV1_DATA_FILENAME_PTR, RAM_DISK_S_LV1_DATA, LV1_DATA_ADDR, LV1_DATA_FILE_LEN)
			call lv1_data_init
			...
			RAM_DISK_M_KNIGHT = RAM_DISK_M3
			RAM_DISK_S_KNIGHT = RAM_DISK_S3
			KNIGHT_ADDR = 46776
			...
			RAM_DISK_M_NPC = RAM_DISK_M3
			RAM_DISK_S_NPC = RAM_DISK_S3
			NPC_ADDR = 62556
