...
;===============================================
			...
			LEVEL1_SNOWFLAK_RAM_DISK_M = RAM_DISK_M1
			LEVEL1_SNOWFLAK_RAM_DISK_S = RAM_DISK_S1
			LEVEL1_SNOWFLAK_ADDR = 0x9CA8
