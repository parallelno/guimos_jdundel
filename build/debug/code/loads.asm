...
;===============================================
			...
			PERMANENT_VFX_RAM_DISK_M = RAM_DISK_M0
			PERMANENT_VFX_RAM_DISK_S = RAM_DISK_S0
			PERMANENT_VFX_ADDR = 0x9234

			PERMANENT_FONT_RAM_DISK_M = RAM_DISK_M0
			PERMANENT_FONT_RAM_DISK_S = RAM_DISK_S0
			PERMANENT_FONT_ADDR = 0x999C

			PERMANENT_VFX4_RAM_DISK_M = RAM_DISK_M1
			PERMANENT_VFX4_RAM_DISK_S = RAM_DISK_S1
			PERMANENT_VFX4_ADDR = 0x8000

			PERMANENT_BOMB_RAM_DISK_M = RAM_DISK_M1
			PERMANENT_BOMB_RAM_DISK_S = RAM_DISK_S1
			PERMANENT_BOMB_ADDR = 0x8F30

			PERMANENT_BACKS0_RAM_DISK_M = RAM_DISK_M1
			PERMANENT_BACKS0_RAM_DISK_S = RAM_DISK_S1
			PERMANENT_BACKS0_ADDR = 0x92F0

			PERMANENT_PAL_MENU_RAM_DISK_M = RAM_DISK_M1
			PERMANENT_PAL_MENU_RAM_DISK_S = RAM_DISK_S1
			PERMANENT_PAL_MENU_ADDR = 0x965A

			PERMANENT_PAL_LV1_RAM_DISK_M = RAM_DISK_M1
			PERMANENT_PAL_LV1_RAM_DISK_S = RAM_DISK_S1
			PERMANENT_PAL_LV1_ADDR = 0x9702
...
; level0
;===============================================
			LEVEL0_NPC4_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_NPC4_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_NPC4_ADDR = 0x0000

			LEVEL0_SKELETON_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_SKELETON_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_SKELETON_ADDR = 0x2AFC

			LEVEL0_CAT_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_CAT_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_CAT_ADDR = 0x518A

			LEVEL0_SCYTHE_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_SCYTHE_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_SCYTHE_ADDR = 0x77DC

			LEVEL0_TI0_DATA_RAM_DISK_M = RAM_DISK_M0
			LEVEL0_TI0_DATA_RAM_DISK_S = RAM_DISK_S0
			LEVEL0_TI0_DATA_ADDR = 0x7DEE

			LEVEL0_BURNER_RAM_DISK_M = RAM_DISK_M1
			LEVEL0_BURNER_RAM_DISK_S = RAM_DISK_S1
			LEVEL0_BURNER_ADDR = 0x0000

			LEVEL0_SWORD_RAM_DISK_M = RAM_DISK_M1
			LEVEL0_SWORD_RAM_DISK_S = RAM_DISK_S1
			LEVEL0_SWORD_ADDR = 0x2346

			LEVEL0_LV0_GFX_RAM_DISK_M = RAM_DISK_M1
			LEVEL0_LV0_GFX_RAM_DISK_S = RAM_DISK_S1
			LEVEL0_LV0_GFX_ADDR = 0x4626

			LEVEL0_GOOSE_RAM_DISK_M = RAM_DISK_M1
			LEVEL0_GOOSE_RAM_DISK_S = RAM_DISK_S1
			LEVEL0_GOOSE_ADDR = 0x5EC4

			LEVEL0_SNOWFLAK_RAM_DISK_M = RAM_DISK_M1
			LEVEL0_SNOWFLAK_RAM_DISK_S = RAM_DISK_S1
			LEVEL0_SNOWFLAK_ADDR = 0x9796

			LEVEL0_FIREPOOL_RAM_DISK_M = RAM_DISK_M1
			LEVEL0_FIREPOOL_RAM_DISK_S = RAM_DISK_S1
			LEVEL0_FIREPOOL_ADDR = 0x9C52

			LEVEL0_NPC_RAM_DISK_M = RAM_DISK_M2
			LEVEL0_NPC_RAM_DISK_S = RAM_DISK_S2
			LEVEL0_NPC_ADDR = 0x0000

			LEVEL0_TI0_GFX_RAM_DISK_M = RAM_DISK_M2
			LEVEL0_TI0_GFX_RAM_DISK_S = RAM_DISK_S2
			LEVEL0_TI0_GFX_ADDR = 0x0E76

			LEVEL0_KNIGHT_RAM_DISK_M = RAM_DISK_M2
			LEVEL0_KNIGHT_RAM_DISK_S = RAM_DISK_S2
			LEVEL0_KNIGHT_ADDR = 0xB044

			LEVEL0_TXT_LV0_RAM_DISK_M = RAM_DISK_M2
			LEVEL0_TXT_LV0_RAM_DISK_S = RAM_DISK_S2
			LEVEL0_TXT_LV0_ADDR = 0xEDE8

			LEVEL0_LV0_DATA_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_LV0_DATA_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_LV0_DATA_ADDR = 0x8000

			LEVEL0_HERO_L_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_HERO_L_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_HERO_L_ADDR = 0x9726

			LEVEL0_HERO_R_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_HERO_R_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_HERO_R_ADDR = 0xCA9E

			LEVEL0_PAL_LV0_RAM_DISK_M = RAM_DISK_M3
			LEVEL0_PAL_LV0_RAM_DISK_S = RAM_DISK_S3
			LEVEL0_PAL_LV0_ADDR = 0xFE16
...
load_level0_load_params:
			...
			FILE_LOAD_PARAMS(HERO_L_FILENAME_PTR, LEVEL0_HERO_L_RAM_DISK_S, LEVEL0_HERO_L_ADDR, HERO_L_FILE_LEN)
			FILE_LOAD_PARAMS(HERO_R_FILENAME_PTR, LEVEL0_HERO_R_RAM_DISK_S, LEVEL0_HERO_R_ADDR, HERO_R_FILE_LEN)
...
load_level0_sprite_init_data:
			...
			.word hero_l_ram_disk_s_cmd
			.byte LEVEL0_HERO_L_RAM_DISK_S | RAM_DISK_M_BACKBUFF | RAM_DISK_M_8F
			.word LEVEL0_HERO_L_ADDR
			.word hero_r_ram_disk_s_cmd
			.byte LEVEL0_HERO_R_RAM_DISK_S | RAM_DISK_M_BACKBUFF | RAM_DISK_M_8F
			.word LEVEL0_HERO_R_ADDR
...
; level1
;===============================================
			LEVEL1_SKELETON_RAM_DISK_M = RAM_DISK_M0
			LEVEL1_SKELETON_RAM_DISK_S = RAM_DISK_S0
			LEVEL1_SKELETON_ADDR = 0x0000

			LEVEL1_BURNER_RAM_DISK_M = RAM_DISK_M0
			LEVEL1_BURNER_RAM_DISK_S = RAM_DISK_S0
			LEVEL1_BURNER_ADDR = 0x268E

			LEVEL1_SWORD_RAM_DISK_M = RAM_DISK_M0
			LEVEL1_SWORD_RAM_DISK_S = RAM_DISK_S0
			LEVEL1_SWORD_ADDR = 0x49D4

			LEVEL1_TNT_RAM_DISK_M = RAM_DISK_M0
			LEVEL1_TNT_RAM_DISK_S = RAM_DISK_S0
			LEVEL1_TNT_ADDR = 0x6CB4

			LEVEL1_FIREPOOL_RAM_DISK_M = RAM_DISK_M0
			LEVEL1_FIREPOOL_RAM_DISK_S = RAM_DISK_S0
			LEVEL1_FIREPOOL_ADDR = 0x70D4

			LEVEL1_VAMPIRE_RAM_DISK_M = RAM_DISK_M1
			LEVEL1_VAMPIRE_RAM_DISK_S = RAM_DISK_S1
			LEVEL1_VAMPIRE_ADDR = 0x0000

			LEVEL1_LV1_GFX_RAM_DISK_M = RAM_DISK_M1
			LEVEL1_LV1_GFX_RAM_DISK_S = RAM_DISK_S1
			LEVEL1_LV1_GFX_ADDR = 0x1D10

			LEVEL1_SCYTHE_RAM_DISK_M = RAM_DISK_M1
			LEVEL1_SCYTHE_RAM_DISK_S = RAM_DISK_S1
			LEVEL1_SCYTHE_ADDR = 0x9796

			LEVEL1_TI0_DATA_RAM_DISK_M = RAM_DISK_M1
			LEVEL1_TI0_DATA_RAM_DISK_S = RAM_DISK_S1
			LEVEL1_TI0_DATA_ADDR = 0x9DA8

			LEVEL1_KNIGHT_RAM_DISK_M = RAM_DISK_M2
			LEVEL1_KNIGHT_RAM_DISK_S = RAM_DISK_S2
			LEVEL1_KNIGHT_ADDR = 0xB044

			LEVEL1_TI0_GFX_RAM_DISK_M = RAM_DISK_M2
			LEVEL1_TI0_GFX_RAM_DISK_S = RAM_DISK_S2
			LEVEL1_TI0_GFX_ADDR = 0xEDE8

			LEVEL1_SNOWFLAK_RAM_DISK_M = RAM_DISK_M2
			LEVEL1_SNOWFLAK_RAM_DISK_S = RAM_DISK_S2
			LEVEL1_SNOWFLAK_ADDR = 0xFA42

			LEVEL1_LV1_DATA_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_LV1_DATA_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_LV1_DATA_ADDR = 0x8000

			LEVEL1_HERO_L_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_HERO_L_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_HERO_L_ADDR = 0x8346

			LEVEL1_HERO_R_RAM_DISK_M = RAM_DISK_M3
			LEVEL1_HERO_R_RAM_DISK_S = RAM_DISK_S3
			LEVEL1_HERO_R_ADDR = 0xB6BE
...
load_level1_load_params:
			...
			FILE_LOAD_PARAMS(HERO_L_FILENAME_PTR, LEVEL1_HERO_L_RAM_DISK_S, LEVEL1_HERO_L_ADDR, HERO_L_FILE_LEN)
			FILE_LOAD_PARAMS(HERO_R_FILENAME_PTR, LEVEL1_HERO_R_RAM_DISK_S, LEVEL1_HERO_R_ADDR, HERO_R_FILE_LEN)
...
load_level1_sprite_init_data:
			...
			.word hero_l_ram_disk_s_cmd
			.byte LEVEL1_HERO_L_RAM_DISK_S | RAM_DISK_M_BACKBUFF | RAM_DISK_M_8F
			.word LEVEL1_HERO_L_ADDR
			.word hero_r_ram_disk_s_cmd
			.byte LEVEL1_HERO_R_RAM_DISK_S | RAM_DISK_M_BACKBUFF | RAM_DISK_M_8F
			.word LEVEL1_HERO_R_ADDR
