...
_TI0_FRAME_INGAME_DIALOG_COPY_LEN = 22
			.word 0 ; safety pair of bytes for reading by POP B
...
_TI0_MAIN_MENU_BACK2_COPY_LEN = 96
			.word 0 ; safety pair of bytes for reading by POP B
...
_TI0_MAIN_MENU_BACK1_COPY_LEN = 83
			.word 0 ; safety pair of bytes for reading by POP B
_ti0_title1:
...
_TI0_FRAME_MAIN_MENU_COPY_LEN = 54
			.word 0 ; safety pair of bytes for reading by POP B
...
_TI0_FRAME_INGAME_TOP_COPY_LEN = 22
			.word 0 ; safety pair of bytes for reading by POP B
_ti0_res_mana:
...
_TI0_RES_POTION_HEALTH_COPY_LEN = 6
			.word 0 ; safety pair of bytes for reading by POP B
...
_TI0_RES_POTION_MANA_COPY_LEN = 6
			.word 0 ; safety pair of bytes for reading by POP B
_ti0_res_tnt:
			.word 0x8000 + (6<<8 | 240)	; scr addr
			.word 0x8000 + (10<<8 | 0)	; scr addr end
