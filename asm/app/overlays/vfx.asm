...
; cc 496
vfx_init4:
; TODO: think of using OVERLAY_INIT instead of the code below
			xchg
			shld @anim_ptr + 1
			...
			L_ADVANCE(overlay_draw_ptr + 1, overlay_anim_ptr, BY_A)
...
@anim_ptr:  ; store anim ptr
			...
			; hl - ptr to overlay_erase_scr_addr_old
...
; TODO: think of using OVERLAY_INIT instead of the code below
			...
			; advance hl to overlay_anim_ptr
			L_ADVANCE(overlay_status, overlay_anim_ptr, BY_A)
