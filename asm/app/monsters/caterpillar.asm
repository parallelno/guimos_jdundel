...
@update_movement:
			ACTOR_UPDATE_MOVEMENT_CHECK_TILE_COLLISION(monster_status_timer, monster_pos_x, CATERPILLAR_COLLISION_WIDTH, CATERPILLAR_COLLISION_HEIGHT, @set_move_init) 
