...
FRIENDS_SIS_ANIM_SPEED_IDLE	= 60
...
villager3_init:
villager4_init:
			MONSTER_INIT(npc_update, npc_draw, friends_sis_impacted, FRIENDS_SIS_HEALTH, ACTOR_STATUS_FRIENDS_SIS_IDLE, npc_sis_idle_anim, False, MONSTER_TYPE_ALLY)
