...
ACTOR_STATUS_HERO_ATTACK		= 1
ACTOR_STATUS_HERO_MOVE			= 2
ACTOR_STATUS_HERO_INVINCIBLE	= 3
ACTOR_STATUS_HERO_IMPACTED		= 4

ACTOR_STATUS_BIT_HERO_BLINK		= %0001_0000
ACTOR_STATUS_BIT_HERO_ANIMATIC	= %0000_1000

ACTOR_STATUS_HERO_DEATH					= 0 | ACTOR_STATUS_BIT_HERO_ANIMATIC
ACTOR_STATUS_HERO_DEATH_FADE_INIT_GB	= 1 | ACTOR_STATUS_BIT_HERO_ANIMATIC
ACTOR_STATUS_HERO_DEATH_FADE_GB			= 2 | ACTOR_STATUS_BIT_HERO_ANIMATIC
ACTOR_STATUS_HERO_DEATH_FADE_R			= 3 | ACTOR_STATUS_BIT_HERO_ANIMATIC | ACTOR_STATUS_BIT_INVIS
ACTOR_STATUS_HERO_DEATH_WAIT_SPARKER	= 4 | ACTOR_STATUS_BIT_HERO_ANIMATIC | ACTOR_STATUS_BIT_INVIS
