.include "app/chars/entities/hero/hero_data.asm"
.include "app/chars/entities/hero/hero_update.asm"
.include "app/chars/entities/hero/hero_collision.asm"
.include "app/chars/entities/hero/hero_tile_funcs.asm"
.include "app/chars/entities/hero/hero_render.asm"
